...
module Legacy = struct
  module Benchmark_program_legacy = struct
    type t = { name : string; body : string; persist : bool }
    [@@deriving show, sexp, fields, csv]
  end

  module Base_benchmark_record_legacy = struct
    type t = {
  ...
  module Benchmark_result_record_legacy = struct
    type t = {
      base_program_loc : string;
      run_id : int;
...
module Current = struct
  module Benchmark_config = struct
